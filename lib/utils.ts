...
export function buildImageUrl(imagePath: string): string {
  ...
  const baseUrl = process.env.NEXT_PUBLIC_URL_IMAGES || 'https://uniapi.onmisales.software';
...
/**
 * Construye una URL de imagen segura, evitando duplicar el dominio
 * cuando la API ya devuelve URLs completas.
 */
